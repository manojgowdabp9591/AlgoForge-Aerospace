...
export default function AdminLayout({
  ...
  // ── LOGIN PAGE: your exact original layout, zero changes ──
  if (isLoginPage) {
    return (
  ...
  return (
    <div className="relative min-h-screen w-full text-white">
      ...
      {/* ── YOUR ORIGINAL BACKGROUND (untouched) ── */}
      <div className="fixed inset-0 bg-black/60 pointer-events-none z-0" />

      {/* ── RED GRID TEXTURE (matches login page) ── */}
        ...
        {sidebarOpen && (
          <motion.aside
            ...
            className="fixed top-0 left-0 h-full w-56 z-30 flex flex-col
              bg-[#0a0a0a] border-r border-red-900/30"
          >
            {/* Top red accent bar (matches login card) */}
            ...
            <div className="px-5 py-5 border-b border-white/[0.05]">
              <div className="flex items-center gap-3 mb-1">
                <div className="p-1.5 bg-red-500/5 rounded-lg ring-1 ring-red-500/20
                  shadow-[0_0_12px_rgba(220,38,38,0.15)]">
                  <ShieldAlert size={16} className="text-red-500" strokeWidth={1.5} />
                </div>
                <div>
                  <div className="text-white font-mono font-black text-sm tracking-[0.15em] uppercase">
                    AlgoForge
                  </div>
                    ...
                    return (
                      <Link
                        ...
                        className={`flex items-center gap-3 px-3 py-2.5 rounded-xl
                          ...
                          transition-all duration-200 mb-1 group relative overflow-hidden
                          ${
                            active
                              ? "bg-red-500/[0.08] text-red-400 border border-red-900/50 shadow-[inset_0_0_20px_rgba(220,38,38,0.03),0_0_12px_rgba(220,38,38,0.1)]"
                      ...
                      >
                        ...
                        {active && (
                          <ChevronRight
                            size={11}
                            className="ml-auto text-red-500/40 relative z-10"
                          />
                        )}
                      </Link>
                    );
            ...
            <div className="px-5 py-3 border-t border-white/[0.05]">
              <p className="text-[9px] text-white/20 uppercase tracking-widest font-mono text-center">
                SYS: VTX-SECURE-V9.2
              </p>
            ...
            <div className="px-3 pb-4">
              <button
                ...
                className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl
                  ...
                  hover:bg-red-500/[0.06] hover:border-red-900/40
      ...
      <button
        ...
        className={`fixed top-4 z-40 flex items-center justify-center
          w-8 h-8 rounded-lg
          bg-[#0a0a0a] border border-red-900/30
          text-white/30 hover:text-red-400
          hover:border-red-900/60
          hover:shadow-[0_0_12px_rgba(220,38,38,0.15)]
